...
import { commandUpdateToken, commandValidateToken, commandClearToken, commandGetBranches } from './commands';
...
export function activate(context: vscode.ExtensionContext) {
	...
	context.subscriptions.push(vscode.commands.registerCommand('github1s.get-github-branches', commandGetBranches));
}
